...
import { DrawerCloseButton } from "../../src/drawer/DrawerCloseButton";
import { useDrawerContext } from "../../src/drawer/DrawerContext";
...
export const New: StoryFn<typeof Drawer> = (args) => {
  ...
  return (
    <>
      ...
      <Drawer open={open} onOpenChange={onOpenChange} id={id} {...args}>
